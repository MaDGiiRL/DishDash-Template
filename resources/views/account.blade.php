                ...
                <div class="col-md-9">
                    <div class="account-container">
                        ...
                        <section id="change-password" class="content-section">
                            ...
                            <h4 class="fw-bold text-dark  mt-5">Delete Account</h4>
                            <a class="btn btn-custom w-100 py-2" href="" onclick="event.preventDefault(); document.querySelector('#form_destroy').submit();">Delete</a>
